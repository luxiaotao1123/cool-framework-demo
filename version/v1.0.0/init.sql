...
-- ----------------------------
BEGIN;
INSERT INTO `sys_resource` VALUES ('1', 'index', '主页', null, '1', '1', '1'), ('2', 'home/console.html', '首页', '1', '2', '1', '1'), ('3', 'system', '系统', null, '1', '2', '1'), ('4', 'user/user.html', '系统用户', '3', '2', '1', '1'), ('5', 'role/role.html', '角色管理', '3', '2', '2', '1'), ('6', 'resource/resource.html', '菜单列表', '3', '2', '3', '1'), ('7', 'set', '设置', null, '1', '999', '1'), ('8', 'detail.html', '基本资料', '7', '2', '1', '1'), ('10', 'userLogin/userLogin.html', '凭证记录', '14', '2', '3', '1'), ('11', 'operateLog/operateLog.html', '操作日志', '14', '2', '988', '1'), ('12', 'merchant', '商户', null, '1', '5', '1'), ('13', 'host/host.html', '商户管理', '12', '2', null, '1'), ('14', 'develop', '开发', null, '1', '998', '1'), ('15', 'permission/permission.html', '权限控制', '14', '2', '1', '1'), ('16', 'api/api.html', '接口文档', '14', '2', '2', '1'), ('17', 'config/config.html', '系统配置', '14', '2', '5', '1');
COMMIT;
...
-- sqlserver
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'home#view', N'查看', '2', '3', '0', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'detail#view', N'查看', '8', '3', '0', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'user#view', N'查看', '4', '3', '0', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'user#btn-add', N'新增', '4', '3', '1', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'user#btn-edit', N'编辑', '4', '3', '2', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'user#btn-delete', N'删除', '4', '3', '3', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'user#btn-export', N'导出', '4', '3', '4', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'user#btn-into', N'导入', '4', '3', '5', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'role#view', N'查看', '5', '3', '0', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'role#btn-add', N'新增', '5', '3', '1', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'role#btn-edit', N'编辑', '5', '3', '2', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'role#btn-delete', N'删除', '5', '3', '3', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'role#btn-export', N'导出', '5', '3', '4', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'role#btn-into', N'导入', '5', '3', '5', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'resource#view', N'查看', '6', '3', '0', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'resource#btn-add', N'新增', '6', '3', '1', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'resource#btn-edit', N'编辑', '6', '3', '2', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'resource#btn-delete', N'删除', '6', '3', '3', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'resource#btn-export', N'导出', '6', '3', '4', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'resource#btn-into', N'导入', '6', '3', '5', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'userLogin#view', N'查看', '10', '3', '0', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'userLogin#btn-add', N'新增', '10', '3', '1', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'userLogin#btn-edit', N'编辑', '10', '3', '2', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'userLogin#btn-delete', N'删除', '10', '3', '3', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'userLogin#btn-export', N'导出', '10', '3', '4', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'userLogin#btn-into', N'导入', '10', '3', '5', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'operateLog#view', N'查看', '11', '3', '0', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'operateLog#btn-add', N'新增', '11', '3', '1', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'operateLog#btn-edit', N'编辑', '11', '3', '2', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'operateLog#btn-delete', N'删除', '11', '3', '3', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'operateLog#btn-export', N'导出', '11', '3', '4', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'operateLog#btn-into', N'导入', '11', '3', '5', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'host#view', N'查看', '13', '3', '0', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'host#btn-add', N'新增', '13', '3', '1', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'host#btn-edit', N'编辑', '13', '3', '2', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'host#btn-delete', N'删除', '13', '3', '3', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'host#btn-export', N'导出', '13', '3', '4', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'host#btn-into', N'导入', '13', '3', '5', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'permission#view', N'查看', '15', '3', '0', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'permission#btn-add', N'新增', '15', '3', '1', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'permission#btn-edit', N'编辑', '15', '3', '2', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'permission#btn-delete', N'删除', '15', '3', '3', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'permission#btn-export', N'导出', '15', '3', '4', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'permission#btn-into', N'导入', '15', '3', '5', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'api#view', N'查看', '16', '3', '0', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'api#btn-add', N'新增', '16', '3', '1', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'api#btn-edit', N'编辑', '16', '3', '2', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'api#btn-delete', N'删除', '16', '3', '3', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'api#btn-export', N'导出', '16', '3', '4', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'api#btn-into', N'导入', '16', '3', '5', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'config#view', N'查看', '17', '3', '0', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'config#btn-add', N'新增', '17', '3', '1', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'config#btn-edit', N'编辑', '17', '3', '2', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'config#btn-delete', N'删除', '17', '3', '3', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'config#btn-export', N'导出', '17', '3', '4', '1');
-- insert [dbo].[sys_resource] ( [code], [name], [resource_id], [level], [sort], [status]) values ( N'config#btn-into', N'导入', '17', '3', '5', '1');