...
//
//    private static final String entityName = "menu";
//
//    public static void main(String[] args) throws IOException {
//        // cool code generator
//        new BuildCodeTemplates(basePackage, entityName).buildCodeFile();
//        // mybatis plus generator
//        new CodeBuilder().mybatisPlusGenerator();
//    }
//
...
//        strategy.setInclude(prefix+entityName); // 需要生成的表
...
//            @Override
//            public String outputFile(TableInfo tableInfo) {
//                return basePath + "/src/main/resources/mapper/" + tableInfo.getEntityName() + "Mapper.xml";
//            }
//        });
//        cfg.setFileOutConfigList(focList);
//        mpg.setCfg(cfg);
