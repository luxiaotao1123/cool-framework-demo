...
layui.use(['table','laydate', 'form'], function(){
    ...
    tableIns = table.render({
        ...
        cols: [[
            ...
            ,{field: 'areaName', align: 'center',title: '上级区域',event: 'Area', style: 'text-decoration: underline;cursor:pointer'}
    ...
    table.on('tool(area)', function(obj){
        ...
        switch (obj.event) {
            ...
            case 'edit':
                ...
                break;
            case 'Area':
                var param = top.reObject(data).areaId;
                if (param === undefined) {
                    layer.msg("无数据");
                } else {
                   layer.open({
