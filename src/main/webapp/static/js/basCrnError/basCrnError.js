...
//            ,{field: 'id', title: 'ID', sort: true,align: 'center', fixed: 'left', width: 80}
            ,{field: 'errorCode', align: 'center',title: '异常代号', sort:true}
            ,{field: 'errName', align: 'center',title: '异常描述'}
